...
{{--                                </nav>--}}
                                ...
                                <div>
                                    ...
                                    <span class="product_info">{{ $product->description }}</span><br>
                                    ...
                                    <div>
                                        ...
                                        <div class="row" style="margin-top: 15px;">
                                            <div class="col-xs-6 form-group" style="margin-left: 15px; font-size: 16px; font-weight: 600">
                                                <span class="product_options">Available Options</span><br>
                                                <div>
                                                @forelse($product_variant as $variant)
                                                    <div>
                                                    <input required type="radio" name="variant" value="{{ $variant->variant_id }}" class="">
                                        ...
                                        <div class="row" style="margin-top: 15px;">
                                            <div class="col-xs-6 form-group" style="margin-left: 15px; font-size: 16px; font-weight: 600">
                                                <span class="product_options">Add-ons</span><br>
                                                <div>
                                                    @forelse($product_addons as $addon)
                                                        <div>
                                                            <input type="checkbox" name="addons[]" value="{{ $addon->addon_id }}" class="">
                                                            <span class="text-danger">{{ $addon->addon_name }} - BDT {{ $addon->addon_price }}</span> &nbsp;
                                                        </div>
                                                    @empty
                                                    @endforelse
                                                </div>
